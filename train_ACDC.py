...
from trainter_ACDC import trainer_ACDC
...
if __name__ == "__main__":
    ...
    from UC_nets.UCTransNet import UCTransNet
    import warnings
    import Config as config
    from networks.UNet import UNet
    net = CAAFNet(num_classes=args.num_classes).cpu()

    #     net = UCTransNet(config_vit, n_channels=config.n_channels, n_classes=config.n_labels)
    config_vit = config.get_CTranS_config()
    net = UCTransNet(config_vit, n_channels=1, n_classes=4)
