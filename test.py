...
parser.add_argument('--volume_path', type=str,
                    default='D:/learn_pytorch/Swin-Unet-main/data/Synapse/test_vol_h5/', help='root dir for validation volume data')  # for acdc volume_path=root_dir
parser.add_argument('--prob_path', type=str, default='D:/learn_pytorch/MISSFormer/result1/anatomical_probabilities.npz',
                    help='Path to the anatomical probability file')
